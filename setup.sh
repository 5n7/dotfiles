...
create_symlink "${DOTFILES_DIR}/.codex/skills/code-review" "${HOME}/.codex/skills/code-review"
...
create_symlink "${DOTFILES_DIR}/.config/oh-my-posh" "${XDG_CONFIG_HOME}/oh-my-posh"
